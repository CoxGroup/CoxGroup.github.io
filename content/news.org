...
#+DESCRIPTION: Latest news from the Cox Group at Durham University: papers, talks, prizes, and updates from the group.
#+OPTIONS: num:nil toc:nil
#+HTML_HEAD_EXTRA: <meta property="og:type" content="website">
#+HTML_HEAD_EXTRA: <meta property="og:title" content="Cox Group News">
#+HTML_HEAD_EXTRA: <meta property="og:description" content="Latest news from the Cox Group at Durham University: papers, talks, prizes, and updates from the group.">
#+HTML_HEAD_EXTRA: <meta property="og:url" content="https://coxgroup.github.io/news.html">
#+HTML_HEAD_EXTRA: <meta property="og:image" content="https://coxgroup.github.io/images/group_sept2026.jpg">
#+HTML_HEAD_EXTRA: <meta name="twitter:card" content="summary_large_image">

* 2026

#+begin_news
*John becomes Project Chemist at Isaac Physics!* /(24 September 2026)/

Having successfuly defended his PhD thesis, John has successfully
secured a job as a Project Chemist with the [[https://isaacscience.org][Isaac Science
Project]]. John will be working with the Isaac Science team in expanding
the Chemistry side of the initiative.
...
#+begin_news
*Connie's paper published in Electrochim. Acta!* /(23 September 2026)/

Congratulations to Connie on her first first-author paper!

[[https://doi.org/10.1016/j.electacta.2026.149863][Molecular interpretability of the bulk electrochemical impedance of
concentrated electrolytes]]

In this paper we present a new model for analysing bulk impedance data
that directly reports on microscopic timescales. We show that the
success of this model lies in its ability to quantify the separation
of timescales within the liquid's memory function. Alongside this we
suggest a transparent, minimal model for the Debye-Falkenhagen effect
that allows us to reproduce our qualitative understanding of
subdiffusive behaviour in an ionic liquid in a quantitative manner.
#+end_news

#+begin_news
*Thermodynamics 2026, London* /(13-15 September 2026)/

After a quiet summer, it's been a busy week; Steve, Alex, and Dom
attended the Thermodynamics 2026 meeting held at Imperial, straight
after the trip to Paris. Steve presented a short talk summarizing Anna
Bui's PhD work on neural cDFT for complex liquids.

#+ATTR_HTML: :alt Steve Cox presenting a talk.
[[file:images/news/thermo2026.jpg]]
/Steve presenting Anna Bui's PhD work at Thermodynamics 2026 in London/
#+end_news


#+begin_news
*DFT Days 2026, Paris* /(9-11 September 2026)/

Last week, the group visited Paris for the annual DFT days
meeting. Steve presented the latest work from Dom and Connie in which
they are extending neural cDFT to describe electrochemical systems.

#+ATTR_HTML: :alt Steve Cox presenting a talk.
[[file:images/news/DFTdays2026.jpg]]
/Steve presenting Dom and Connie's work at DFT Days 2026 in Paris/

While in the beautiful and historic setting of the Sorbonne, we also
took the opportunity to update our group photo!

#+ATTR_HTML: :alt Cox group at Sorbonne University, Paris.
[[file:images/group_sept2026.jpg]]
/Left to right: Jan, Dom, Steve, Connie, Edward, Alex/
#+end_news

#+begin_news
*Goodbye and good luck, Anna!* /(1 September 2026)/

Today we bid farewell to Anna, who leaves the group after five
years. While we are very sad to see her go, we are also delighted and
excited for her new adventure as a Research Fellow at Stanford
University.

Anna has achieved a great deal during her PhD studies and has been a
tremendous source of support for other members of the group. We are
grateful for all her contributions and wish her every success in her
new role.
#+end_news
...
#+ATTR_HTML: :alt Anna Bui, John Hayton, and Steve Cox.
